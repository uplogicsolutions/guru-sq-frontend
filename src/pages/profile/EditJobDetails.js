...
const EditJobDetails = (props) => {
    ...
    const [show_accordian, setShowAccordian] = useState(true);
    ...
    return (
        <Panel shaded style={{ background: 'white' }}>
            ...
            {show_accordian && temp_jobs &&
                <div>
                    <h4>Your Jobs</h4>
                    <PanelGroup style={{ marginTop: 10 }} accordion bordered>
                        {jobs && temp_jobs.map((job, index) => {
                            return (
                    ...
                    <Row style={{ marginTop: 15 }}>
                        <Col xs={24} sm={24} md={24}>
                            <Controller
                                name="supplementary_subjects"
                                control={control}
                                defaultValue={job.supplementary_subjects}
                                options={subjectsData}
                                as={
                                    <TagPicker
                                        name="supplementary_subjects"
                                        block
                                        value={job.supplementary_subjects}
                                        placeholder="Supplementary Subject"
                                        data={subjectsData}
                                    />
                                }
